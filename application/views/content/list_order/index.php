        ...
        <form id="searchForm" class="form-inline">
          <div class="pull-left">
            ...
            <span id="filterInstalasi">
              ...
              <select name="instalasi" id="instalasi">
            ...
            <span>
              <button class="btn btn-primary btn-xs" type="submit" id="cari">Cari</button>
            </span>
...
<script type="text/javascript">
  ...
  function download_order(){
    ...
    //     }
    //   });
    window.open('<?= site_url('list_order/export?tglawal=')?>'+tglawal+'&tglakhir='+tglakhir+'&instalasi='+instalasi);
  }
