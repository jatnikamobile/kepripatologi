  ...
  <?php foreach ($data as $key => $l): ?>
    <tr data-notran="<?= $l->NoTran ?>">
      ...
      <td>
        ...
        <p><?php if ($l->JenisBayar != 'CASH' || $l->JenisBayar == '' || $l->JenisBayar == null) {
              if (($l->NmInstansi != null || $l->NmInstansi != '') && ($l->Jenis_bayar == null || $l->Jenis_bayar == '')) {
                  echo 'Instansi '.$l->NmInstansi;
              }elseif(($l->NmInstansi != null || $l->NmInstansi != '') && ($l->Jenis_bayar != '')){
                  echo 'LUNAS dari Instansi '.$l->NmInstansi;
              }elseif($l->lainnya != ''){
                  echo $l->lainnya;
              }
              else{
                echo '<span class ="danger" >Belum Lunas</span>';
              }
        }else{
          echo 'LUNAS';
        }  ?></p>
