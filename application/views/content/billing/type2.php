...
<h4 class="rincian"><b>Rincian Biaya Pemeriksaan Patologi Anatomi</b></h4>
<table style="width: 100%;">
	<tr><td>
		...
		<table class="description-table" style="width: 100%; top: 0;">
			<tbody>
				<tr>
					<td style="width: 1.2in;">Tanggal Pemeriksaan</td>
					<td>:</td>
					<td style="width: 70%;"><?php echo $billing->Tanggal;?></td>
				</tr>
				<tr>
