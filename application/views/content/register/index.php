                    ...
                    <form method="post" class="row" id="form-psn-bpjs">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right">Asal Negara</label>
                                    <div class="input-group col-sm-9">
                                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                                        <select type="text" name="kwn" id="kwn" style="width:100%;" class="form-control select2 input-sm">
                                            <?php foreach ($negara as $row): ?>
                                                <option value="<?= $row->nm_negara ?>"><?= $row->nm_negara?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-9">
                                        ...
                                        <select type="text" required name="Kunjungan" id="Kunjungan" style="width:100%;" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-9">
                                        <span class="input-group-addon" id="" style="border:none;background-color:white;">:</span>
                                        <select type="text" name="KategoriPasien" id="Kategori" style="width:100%;" class="form-control select2 input-sm col-xs-6 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-9">
                                        ...
                                        <select type="text" name="KdCbayar" id="cara_bayar" style="width:100%;" class="form-control select2 input-sm col-xs-6 col-sm-6">
                                            ...
                                            <option value="03">JAMINAN</option>
                                            <option value="04">COVID 19</option>
                                            <option value="05">PASIEN ACC</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- Peserta -->
...
<script>
    ...
    $("#submit").on("click",function(e){
        ...
        if ($('#pengobatan').val() == '') {
            alert('Pilih Tujuan!');
        } else if($('#Kunjungan').val() == '') {
            alert('Pilih Kunjungan!');
        } else if($('#poli').val() == '') {
            alert('Pilih Poli!');
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    pesan = response.message + "\n" +
                            ...
                            window.location.replace("<?=base_url('billing/baru/')?>"+response.Regno);                                
                            }
                    // alert(pesan);
                    // if (response.NoSep != '') {
