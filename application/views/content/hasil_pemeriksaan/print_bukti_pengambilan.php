		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12" style="border-top: 1px solid black;">
					<center><h2><b>BUKTI PENGAMBILAN HASIL Patologi Anatomi</b></h2></center>
					<div class="col-xs-12">
						<div class="box1">
					...
					<p><b><i>*  Mohon serahkan bukti pengambilan hasil ini pada saat pengambilan hasil Patologi Anatomi <br>
