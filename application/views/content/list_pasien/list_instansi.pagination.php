...
<div class="pull-left">
  <ul class="pagination" data-serialization="<?= $base_serialization ?>">
    <?php
      ...
      $link = $previous_page
        ? site_url('list_pasien/instansi?'.$serialization)
        : 'javascript:;';
    ...
    <?php
      ...
      $link = site_url('list_pasien/instansi?'.$serialization);
...
<div class="pull-right">
  <b style="margin: 20px 0; display: block;">Jumlah Instansi: <?= $count ?></b>
</div>