...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <ul class="nav nav-tabs nav-justified nav-success" role="tablist">
            ...
            <li role="presentation"><a href="#tarif-lab" aria-controls="tarif-lab" role="tab" data-toggle="tab"><b>Tarif Patologi Anatomi</b></a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade row" id="tarif-lab">
                <div id="halaman" class="col-sm-3 col-md-3">
                    <p><u>Keterangan</u></p>
                    <div class="table-responsive pemeriksaan-tarif">
                        <table class="table table-sm table pemeriksaan-tarif" id="nama_pemeriksaan">
                            <thead>
                                <tr class="success">
                                    <th>Kode</th>
                                    <th>Keterangan</th>
