...
<html lang="en">
	...
	<body class="skin-2">
		<div id="navbar" class="navbar navbar-default navbar-fixed-top" style="background-color:green;">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle" style="background-color:green"><?=$this->session->userdata('username') != '' ? $this->session->userdata('username'):'User'?> &nbsp;
								<!-- <img class="nav-user-photo" src="<?=base_url('assets/new/images/avatars/user.jpg')?>" alt="Jason's Photo" /> -->
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li class="divider"></li>
									<li><a href="<?php echo base_url('Logout')?>"><i class="ace-icon fa fa-power-off"></i>Logout</a></li>
							</ul>
						</li>
					</ul>
				</div>
